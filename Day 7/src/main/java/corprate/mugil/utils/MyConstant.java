...
public class MyConstant {
    ...
    //SWAGGER
    public static final String SWAGGER_INFO_TITLE ="MUGIL";
    public static final String SWAGGER_INFO_DESCRIPTION ="mugil";
    public static final String SWAGGER_INFO_VERSION ="1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME ="mugil";
    public static final String SWAGGER_INFO_CONTACT_EMAIL ="727721eucs084@skcet.ac.in";
